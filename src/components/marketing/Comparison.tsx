...
const comparisonFeatures: ComparisonFeature[] = [
  ...
  },
  {
    ...
    quantumreef: "✓ Desktop, Mobile, CLI",
    copilot: "Editor extensions only",
    cursor: "Desktop app only",
  },
  {
    name: "Workflow States",
    quantumreef: "✓ todo → in_progress → review → done",
    copilot: "No workflow management",
    cursor: "Basic chat history",
  },
  {
    name: "Session Organization",
    quantumreef: "✓ Inbox/Archive + Flagging",
    copilot: "No organization",
    cursor: "Folder-based only",
  },
  {
    name: "Enterprise Security",
    quantumreef: "✓ 4 permission modes + CVE hardening",
    copilot: "Cloud-based auth",
    cursor: "Local-first",
  },
  {
    name: "Open Source",
  ...
  {
    name: "MCP Tools",
    quantumreef: "✓ Native integration",
